...
public class NextGreaterElement {
    public static void findNextGreaterElement(int[] arr) {
        ...
        // Create a collections.stack to store the indices of the elements
        ...
        for (int i = 0; i < n; i++) {
            ...
            // Push current index onto the collections.stack
            stack.push(i);
        }

        // For remaining elements in the collections.stack, set NGE as -1
        while (!stack.isEmpty()) {
            nge[stack.pop()] = -1;
        }
